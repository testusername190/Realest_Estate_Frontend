...
const ListingForm = (props) => {
    ...
    const bhagwaan = () => {
        ...
        axios.post('http://127.0.0.1:8000/api/listings/search', {
            ...
            open_house: `0`,//manually sending data as it was throwing error
            keywords: `${keywords}`
            ...
            <div className='row'>
                ...
                <div className='col-1-of-6'>
                    {loading ?
                        ...
                        <button className='listingform__button listingform__button--primary' onClick={bhagwaan}>Save</button>
                    }
                </div>
            </div>
        </form>
